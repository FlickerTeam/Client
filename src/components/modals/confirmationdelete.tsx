...
export const ConfirmationDeleteModal = ( { name, id, type } : {
    name: string
    id: string;
    type: string;
}) : JSX.Element => {
    ...
    return (
        <div className="confirmation-leave-modal">
            <p>Are you sure you want to delete the {type} "<b>{name}"</b>?</p>
            <p><b>Once it's gone, it's gone.</b></p>
            <div className="modal-footer" style={{
                gap: '15px'
            }}>
                <button onClick={closeModal} className="join-btn">Cancel</button>
                <button onClick={() => deletePlace(id, type)} style={{
