...
export const ServerProfileModal = ({ member }: { member: any }): JSX.Element => {
    ...
    const avatarUrl = (member.user.avatar) ? `${localStorage.getItem("selectedAssetsUrl")}/avatars/${member.id}/${member.user.avatar}.png` : `${localStorage.getItem("selectedCdnUrl")}/assets/${getDefaultAvatar(member.user)}.png`;
            ...
            <div className="profile-modal-body">
               ...
               {member.user.bio && (
                ...
                <div className="popout-section">
                    ...
                    <textarea 
                        className="note-input modal-note" 
