    ...
    return (
        <>
            <div className="confirmation-leave-modal">
                <p>Are you sure you want to clear <b>{getFormattedUrl()}</b> from your localStorage?</p>
            <p><b>This will log you out and you won't be able to chat on this instance unless you select it again.</b></p>
            <div className="modal-footer" style={{
                gap: '15px'
            }}>
                <button onClick={closeModal} className="join-btn">Cancel</button>
                <button onClick={() => clearSelectedInstance()} style={{
