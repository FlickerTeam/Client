...
const RegisterForm = ({ handleInstanceSelect, handleSignup, instances, instance, errorMsg, status, customInstance, setCustomInstance, setUsername, username, email, setEmail, password, setPassword } : {
