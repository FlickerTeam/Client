      ...
      <div className="context-menu-out guild-context-menu">
        ...
        {!isOwner && (
          <>
            ...
            <div 
              ...
              onClick={() => handleLeaveServer(guild.name, guild.id)}
            >
              Leave Server
            </div>
          </>
        ...
        {isOwner && (
          <>
            ...
            <div className="button" style={{ color: 'var(--bg-dnd)' }} onClick={() => handleDeleteServer(guild.name, guild.id)}>Delete Server</div>
          </>
        )}
      </div>
    ));
    ...
    <div id="guilds-column">
      ...
      {guilds.map((guild: Guild) => (
        <div
          ...
          onContextMenu={(e) => handleRightClick(e, guild)}
        >
          {guild.icon ? (
