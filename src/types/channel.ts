...
export const ChannelSchema = z.object({
  ...
  user_limit: z.coerce.number().nullish(),
  rate_limit_per_user: z.coerce.number().max(21600).nullish(),
  recipients: z.array(UserSchema.partial()).nullish(),
  recipient_flags: z.coerce.number().nullish(),
  ...
  message_count: z.coerce.number().nullish(),
  ...
  default_forum_layout: z.coerce.number().nullish(),
  default_sort_order: z.coerce.number().nullish(),
  ...
  theme_color: z.coerce.number().nullish(),
